<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                <div class="px-7 py-4 bg-white">
                    <form action="{{ route('prestasi.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        {{-- Nama Prestasi --}}
                        <div class="space-y-2">
                            <label for="nama_prestasi" class="block text-sm font-semibold text-gray-700">Nama Prestasi <span class="text-red-500">*</span></label>
                        ...
                        {{-- Deskripsi --}}
                        <div class="space-y-2">
                            <label for="deskripsi_prestasi" class="block text-sm font-semibold text-gray-700">Deskripsi <span class="text-red-500">*</span></label>
                        ...
                        {{-- Tanggal Perolehan --}}
                        <div class="space-y-2">
                            <label for="tanggal_perolehan" class="block text-sm font-semibold text-gray-700">Tanggal Perolehan <span class="text-red-500">*</span></label>
                        ...
                        {{-- Tingkatan --}}
                        <div class="space-y-2">
                            <label for="tingkatan_prestasi" class="block text-sm font-semibold text-gray-700">Tingkatan Prestasi <span class="text-red-500">*</span></label>
                        ...
                        {{-- Jenis --}}
                        <div class="space-y-2">
                            <label for="jenis_prestasi" class="block text-sm font-semibold text-gray-700">Jenis Prestasi <span class="text-red-500">*</span></label>
                        ...
                        <div class="space-y-2">
                            <label for="dokumentasi_prestasi" class="block text-sm font-semibold text-gray-700">Dokumentasi Prestasi <span class="text-red-500">*</span></label>
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-4">
                            <a href="{{ route('dashboard') }}"
                                class="px-6 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                Kembali
                            </a>
                            <button type="submit"
                                class="px-6 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#4B83BF] hover:bg-[#5a93c7] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                Kirim Prestasi
                            </button>
                        </div>
                    </form>
    ...
    <script>
        ...
        function addDokumentasi() {
            ...
            newRow.innerHTML = `
                <input type="file" name="dokumentasi_prestasi[]" class="block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" accept="image/*" required>
