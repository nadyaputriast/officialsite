<section class="bg-[#DDF1FB]">
    <div id="download-section" class="py-8 md:py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl p-4 md:p-6 shadow-md border hover:shadow-lg transition-all duration-300 hover:-translate-y-1 relative">
                <div class="p-4 md:p-6 text-gray-900">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="jenis_konten"
                                            ...
                                            <option value="Materi Kuliah" {{ request('jenis_konten') == 'Materi Kuliah' ? 'selected' : '' }}>Materi Kuliah</option>
                                            <option value="Aplikasi" {{ request('jenis_konten') == 'Aplikasi' ? 'selected' : '' }}>Aplikasi</option>
                                            <option value="Manual Book" {{ request('jenis_konten') == 'Manual Book' ? 'selected' : '' }}>Manual Book</option>
                                            <option value="Source Code" {{ request('jenis_konten') == 'Source Code' ? 'selected' : '' }}>Source Code</option>
                                            <option value="Template" {{ request('jenis_konten') == 'Template' ? 'selected' : '' }}>Template</option>
                                            <option value="Dataset" {{ request('jenis_konten') == 'Dataset' ? 'selected' : '' }}>Dataset</option>
                                            <option value="E-book" {{ request('jenis_konten') == 'E-book' ? 'selected' : '' }}>E-book</option>
                                        </select>
                                    </div>
                                    {{-- Filter by status_download --}}
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Status Download</label>
                                        <select name="status_download"
                                            class="w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                            <option value="">Semua Status</option>
                                            <option value="1" {{ request('status_download') == '1' ? 'selected' : '' }}>Sudah Divalidasi</option>
                                            <option value="0" {{ request('status_download') == '0' ? 'selected' : '' }}>Belum Divalidasi</option>
                                        </select>
                                    </div>
                                    {{-- Sort --}}
                                    <div>
                    ...
                    @else
                        ...
                        <div class="mb-6 bg-gray-50 rounded-lg p-4">
                            <form method="GET" action="{{ route('dashboard') }}#download-section" class="space-y-4">
                                ...
                                <div class="flex flex-col sm:flex-row gap-3">
                                    <button type="submit"
                                        class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition font-medium w-full sm:w-auto text-center">
                                        Cari
                                    </button>
                        ...
                        @forelse ($dataDownload as $download)
                            ...
                            @endif
                            <div class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition overflow-hidden flex flex-col h-full">
