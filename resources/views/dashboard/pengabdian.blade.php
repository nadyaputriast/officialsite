                                ...
                                <div class="grid md:grid-cols-4 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="status_pengabdian"
                                            ...
                                            <option value="1"
                                                {{ request('status_pengabdian') == '1' ? 'selected' : '' }}>Sudah
                                                Divalidasi</option>
                                            <option value="0"
                                                {{ request('status_pengabdian') == '0' ? 'selected' : '' }}>Belum
                                                Divalidasi</option>
                                        </select>
                                    </div>
                            ...
                            <table class="table-auto w-full border-collapse border border-gray-300">
                                <thead>
                                    <tr class="bg-gray-100">
                                        <th class="border border-gray-300 px-4 py-2" rowspan="2">Judul Pengabdian
                                        </th>
                                        <th class="border border-gray-300 px-4 py-2" rowspan="2">Deskripsi Pengabdian
                                        </th>
                                        <th class="border border-gray-300 px-4 py-2" rowspan="2">Tanggal Pengabdian
                                        </th>
                                        <th class="border border-gray-300 px-4 py-2" rowspan="2">Pelaksana</th>
                                        <th class="border border-gray-300 px-4 py-2" rowspan="2">Dokumentasi
                                            Pengabdian</th>
                                ...
                                <tbody>
                                    @forelse ($dataPengabdian as $pengabdian)
                                        <tr>
                                            ...
                                            <td class="border border-gray-300 px-4 py-2">
                                                {{ $pengabdian->tanggal_pengabdian }}</td>
                                            <td class="border border-gray-300 px-4 py-2">
                                                {{ $pengabdian->pelaksana }}</td>
                                            <td class="border border-gray-300 px-4 py-2">
                                                @if ($pengabdian->dokumentasi->count() > 0)
                                                    @foreach ($pengabdian->dokumentasi as $dokumentasi)
                                                        <a href="{{ asset('storage/' . $dokumentasi->dokumentasi_pengabdian) }}"
                                                            target="_blank">
                                                            <img src="{{ asset('storage/' . $dokumentasi->dokumentasi_pengabdian) }}"
                                                                alt="Dokumentasi Pengabdian"
                                            ...
                                            <td class="border border-gray-300 px-4 py-2">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    @if ($pengabdian->status_pengabdian == 0)
                                                        <form
                                                            action="{{ route('pengabdian.komentar', $pengabdian->id_pengabdian) }}"
                                            ...
                                            <td class="border border-gray-300 px-4 py-2">
                                                <div class="flex gap-2 flex-wrap">
                                                    ...
                                                    @if ($pengabdian->status_pengabdian == 0)
                                                        <form
                                                            ...
                                                            <button type="submit"
                                                                ...
                                                                onclick="return confirm('Yakin ingin memvalidasi pengabdian ini?')">
                                                                Validasi
                                                            </button>
                                                        </form>
                                                    @endif
                                                    ...
                                                    @if (auth()->user()->hasRole('admin'))
                                                        <form
                                                            action="{{ route('pengabdian.destroy', $pengabdian->id_pengabdian) }}"
                                                            method="POST" class="inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="bg-red-600 text-white px-2 py-1 rounded hover:bg-red-700 transition"
                                                                onclick="return confirm('Yakin ingin menghapus pengabdian ini?')">
                                                                Hapus
                                                            </button>
                                                        </form>
                                                    @endif
