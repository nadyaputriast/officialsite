                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('event.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="px-6 py-4 mb-6 bg-zinc-100 rounded-[10px]">
                            ...
                            {{-- Tambahin buat Tempat --}}
                        </div>

                        <div class="px-6 py-4 mb-6 bg-zinc-100 rounded-[10px]">
                            <h3 class="mb-3 text-black font-medium">Kategori & Detail</h3>
                            {{-- Jenis Event --}}
                            <div class="mb-4">
                        ...
                        <div class="flex gap-4">
                            <button type="submit"
                                class="px-6 py-3 bg-blue-500 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 font-medium">
                                Simpan Event
                            </button>
